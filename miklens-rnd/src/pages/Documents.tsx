...
const mockDocs = [
  ...
  { id: 2, name: 'Fungal_Culture_Day5.jpg', type: 'Image', size: '4.1 MB', date: 'Oct 23, 2023' },
        ...
        {mockDocs.map((doc, index) => (
          ...
          >
            ...
            <button
              ...
              className="flex-shrink-0 text-gray-400 hover:text-blue-500 dark:hover:text-blue-400 opacity-0 transition-opacity group-hover:opacity-100"
            >
