              ...
              <div className="relative pb-8">
                ...
                <div className="relative flex items-start space-x-3">
                  <div className="relative">
                    <img className="flex h-10 w-10 items-center justify-center rounded-full bg-gray-400 ring-8 ring-white dark:ring-gray-950" src={`https://i.pravatar.cc/150?u=${obs.id}`} alt={`${obs.author}'s avatar`} loading="lazy" />
                  </div>
